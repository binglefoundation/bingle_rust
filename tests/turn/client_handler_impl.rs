...
#[test]
fn client_handle_listen_fails_with_error() {
...
#[test]
fn client_incoming_from_listener_relay_on_open_channel() {
    let client = TurnClientHandlerImpl::new();
...
#[test]
fn client_incoming_from_called_relay_returns_wrapped() {
    let client = TurnClientHandlerImpl::new();
...
#[test]
fn client_send_outgoing_wraps_and_fails_without_channel() {
    let client = TurnClientHandlerImpl::new();
...
#[test]
fn client_listen_response_registers_allowed_but_not_channel() {
    let client = TurnClientHandlerImpl::new();
...
#[test]
fn client_call_response_registers_allowed_and_channel() {
    let client = TurnClientHandlerImpl::new();
...
#[test]
fn client_called_after_listen_response_registers_channel() {
    let client = TurnClientHandlerImpl::new();
