...
pub fn engine_restart_reidentifies_after_stop() {
    ...
    assert_eq!(eng.state(), EngineState::TrianglePing, "session 1 should reach TrianglePing");
    assert_eq!(eng.last_public_addr(), Some(addr_p), "session 1 should remember public addr P");
    ...
    assert_eq!(eng.last_public_addr(), Some(addr_q), "restart should adopt the new public addr Q");
