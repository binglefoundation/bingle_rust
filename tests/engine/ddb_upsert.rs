...
pub fn ddb_upsert_success_when_server_is_relay() {
    ...
    let record = AdvertRecord::new_unsigned(client_id.clone(), Some(InetSocketAddress{ host: "127.0.0.1".into(), port: 9999 }), Some(false), None, None, "2025-01-01T00:00:00Z".into());
