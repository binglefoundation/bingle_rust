use rust_comms::util::cli::parse_start_options_from_args;
use std::net::SocketAddr;

#[test]
fn parse_positional_handle_and_flags() {
    let args = vec![
        "myhandle".to_string(),
...
#[test]
fn parse_handle_flag_and_static_ip() {
    let args = vec![
