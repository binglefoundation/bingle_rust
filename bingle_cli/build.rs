...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Build number logic: share the repo-root counter with bingle_core so the CLI reports a
    // build number coherent with the rest of the workspace.
    ...
    // If the user wants to force a rebuild, they should touch src/main.rs or Cargo.toml.
