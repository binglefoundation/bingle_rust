...
use bingle_core::ddb::{DdbClient, DdbClientImpl};
...
pub fn ddb_client_register_relay_ok_and_persisted() {
    ...
    let q = bingle_core::messages::types::Message::Ddb(
        bingle_core::messages::types::DdbMessage::QueryResolve(
            bingle_core::messages::types::DdbQueryResolve {
                app: "ddb".to_string(),
                id: client_id.clone(),
                tag: None,
                text: None,
    ...
    let json = bingle_core::messages::marshal::to_json_value(&q);
