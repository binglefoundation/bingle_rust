...
pub fn test_relay_ping_handler_honors_exclusions() {
    ...
    impl Dtls for MockDtls {
        ...
        fn set_handle_message(&self, _h: Option<HandleMessage>) {}
        ...
        fn set_ca_cert(&self, _p: Option<Vec<u8>>) {}
        ...
        fn set_client_cert(&self, _p: Option<Vec<u8>>) {}
        ...
        fn set_client_private_key(&self, _p: Option<Vec<u8>>) {}
        ...
        fn set_server_signing_cert(&self, _p: Option<Vec<u8>>) {}
        ...
        fn set_server_signing_private_key(&self, _p: Option<Vec<u8>>) {}
