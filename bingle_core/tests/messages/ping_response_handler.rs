use bingle_core::messages::Router;
use std::sync::{Arc, Mutex};

use bingle_core::api::bingle_api::{Handle, NetworkEndpoint, UserId};
use bingle_core::messages::handlers::MessageHandler;
use bingle_core::messages::types::PingResponse;
...
pub fn test_on_ping_response_no_tag_calls_on_message() {
    ...
    let handler = bingle_core::messages::DefaultPrintingHandler;
