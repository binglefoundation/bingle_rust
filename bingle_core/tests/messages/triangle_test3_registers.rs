...
use bingle_core::messages::types::RelayTriangleTest3;
...
pub fn triangle_test3_triggers_ddb_register_and_sets_registered() {
    ...
    // router.set_bingle_api_internal(Some(internal.clone() as Arc<dyn bingle_core::api::bingle_api::BingleApiInternal>));
