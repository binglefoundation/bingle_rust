...
use bingle_core::messages::handlers::{TRIANGLE_TEST_1_DELAY, send_triangle_test1_response};
...
fn make_api(tracking: Arc<TrackingApi>) -> Arc<dyn bingle_core::api::bingle_api::BingleApiBoth> {
