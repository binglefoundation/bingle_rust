// Extracted from tests/security/weak_key_exchange_test.rs.
// rsa_1024_client_cert_rejected binds sockets and does a live loopback DTLS handshake;
// nextest flagged it as leaky (a socket/subprocess handle outlived the test) under load.
// Its sibling tests (dh_1024_rejected, rsa_1024_server_cert_rejected) stay in the unit suite.
