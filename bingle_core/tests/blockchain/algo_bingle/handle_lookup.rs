...
#[test]
#[cfg(not(target_os = "ios"))]
pub fn test_extract_handle_prefix_match_found() {
    ...
    let mut matches = Vec::new();
    AlgoBingle::extract_handle_prefix_match(&acct, app_id, "al", &mut matches);
...
#[test]
#[cfg(not(target_os = "ios"))]
pub fn test_extract_handle_prefix_match_normalised() {
    ...
    let mut matches = Vec::new();
    AlgoBingle::extract_handle_prefix_match(&acct, app_id, "abc", &mut matches);
...
#[test]
#[cfg(not(target_os = "ios"))]
pub fn test_extract_handle_prefix_match_no_match() {
    let app_id = 123;
    let acct = json!({
        "address": "ADDR1",
        "apps-local-state": [{
    ...
    let mut matches = Vec::new();
    AlgoBingle::extract_handle_prefix_match(&acct, app_id, "bob", &mut matches);
    assert!(matches.is_empty());
}

#[test]
#[cfg(not(target_os = "ios"))]
pub fn test_extract_handle_prefix_match_empty_prefix_never_matches() {
    let app_id = 123;
    let acct = json!({
        "address": "ADDR1",
        "apps-local-state": [{
    ...
    AlgoBingle::extract_handle_prefix_match(&acct, app_id, "", &mut matches);
    AlgoBingle::extract_handle_prefix_match(&acct, app_id, "!!", &mut matches);
    assert!(matches.is_empty());
}
